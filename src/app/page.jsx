    ...
    <div className="">
      <div className="absolute z-20 w-full">
        <div className="flex justify-between">
          <div className="border border-red-500 content-center w-1/3">
            <div className="border text-blue-900 text-6xl justify-self-center">
              Habitude
            </div>
            <div>text</div>
          </div>

          <div className="border border-green-500 min-h-screen w-1/3 flex items-center justify-center">
            {isLoading ? (
