          ...
          <div className="col-span-9 space-y-6">
            ...
            <div className="bg-white p-6 rounded-2xl shadow">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <LeaderboardCard title="Current Streak" data={dummyData.currentStreak} />
                <LeaderboardCard title="Best Streak" data={dummyData.bestStreak} />
                <LeaderboardCard title="Overall Completion" data={dummyData.completion} />
              </div>
            </div>
          </div>
        </div>
