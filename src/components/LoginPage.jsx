...
export default function LoginPage() {
  ...
  return (
    <div className="bg-[url(/landing.png)] h-screen flex bg-bottom bg-no-repeat">
      ...
      <div className="w-1/2 pl-10 content-center">
        <div className=" mt-10 h-1/2  justify-self-center">
              ...
              <div className="p-8 rounded-lg  w-full max-w-md">
                ...
                <div className="space-y-4">
                  <button
                    onClick={handleGoogleSignIn}
                    disabled={isLoading}
                    className="text-xs w-full flex items-center justify-center gap-3 py-2 px-4 border-2 border-blue-800 text-blue-800 rounded-3xl hover:bg-gray-50 cursor-pointer"
                  >
                    <svg className="w-5 h-5" viewBox="0 0 24 24">
                      <path
                        fill="currentColor"
          ...
          <div className="p-8  w-1/2 justify-self-center">
            <div className="text-lg mb-8">
              <ul>
                <li>Habits with purpose.</li>
                <li>Progress you can see.</li>
              </ul>
            </div>

            <div className="text-sm">
              Whether you're getting started or leveling up your daily routine,
              Habitude helps you build momentum, one habit at a time.
            </div>
          </div>
        </div>
      </div>
